...
# one word if present contributing only 1 from that document.
# thus idf is sorted as total/no. of documents containing that word
...
#this will add same document index if the word repeats itself in the document...
#thus giving tf...as tf(word, document) = no of times that word present in the document/total words in the doucument
